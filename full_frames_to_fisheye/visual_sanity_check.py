...
# use your distort_image implementation or precomputed remap
# here assume distort_image(img, params) exists and returns PIL Image.
@dataclass
...
for x in range(0, w+1, 80):
    draw.line([(x,0),(x,h)], fill=(200,200,200), width=2)
# horizontal lines
for y in range(0, h+1, 120):
    draw.line([(0,y),(w,y)], fill=(200,200,200), width=2)

distorted = distort_image(img, params)   # your function
distorted.show()
